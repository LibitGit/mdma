...
extern "C" {
    ...
    pub async fn get(this: &Windows, window_id: i32) -> Result<Window, JsValue>;

    #[wasm_bindgen(catch, method, js_name = getCurrent)]
    pub async fn get_current(this: &Windows) -> Result<Window, JsValue>;
    ...
    #[wasm_bindgen(method)]
    pub async fn create(this: &Windows, info: &Object) -> Window;
